...
void Read_Keypad()
{
  ...
  if(C2==0){Delay(10);while(C2==0);octave=4.0;press=1;}
  if(C3==0){Delay(10);while(C3==0);octave=16.0;press=1;}
  if(C4==0){Delay(10);while(C4==0);octave=32.0;press=1;}
...
{
    for(i=0; i<24; i++)
    table[i] = sin(2.0*3.1415927*(float)i/24.0);
}*/
